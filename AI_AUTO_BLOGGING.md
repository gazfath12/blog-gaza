...
3. **Groq AI (Llama 3)** memilih topik terbaik dan membuat artikel lengkap (>1200 kata) dengan format Markdown.
...
1.  **Dapatkan API Key**:
    *   Ambil **Groq API Key** dari [Groq Cloud Console](https://console.groq.com/).
...
2.  **Atur GitHub Secrets**:
    ...
    *   Tambahkan Secrets baru:
        *   `GROQ_API_KEY`: (Isi dengan API Key Groq)
